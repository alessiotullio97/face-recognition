...
%         res = -1;
%         % Create n (n is the actual number of faces within the database)
%         % class classifier using  
...
%         
        ...
        subplot(1,2,2); imshow(read(app.training(integerIndex),1)); title("Matched Class");
